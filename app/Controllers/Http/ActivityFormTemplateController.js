...
class ActivityFormTemplateController {
  ...
  /**
   * Render a form to be used for creating a new activityformtemplate.
   * GET activityformtemplates/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing activityformtemplate.
   * GET activityformtemplates/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
