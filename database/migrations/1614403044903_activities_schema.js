...
class ActivitiesSchema extends Schema {
  up() {
    this.create('activities', (table) => {
      ...
      table.date('begin_date').nullable().default(null)
      table.date('end_date').nullable().default(null)
      table.date('register_begin_date').nullable().default(null)
      table.date('register_end_date').nullable().default(null)
